...
await message.client.sendMessage(message.jid, Buffer.from(lasi.data), MessageType.image, {mimetype: Mimetype.png, caption: ' Queen NCC ALIVE ✅           '+Config.ALIVETEXT+'\n          NCCරැජින online ව ඇත.'})
    }));
